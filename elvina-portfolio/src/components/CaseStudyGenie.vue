<template>
      <div class="main-wrapper flex flex-col xl:mx-[100px] lg:mx-[50px] xs:mx-[20px] justify-center items-center">
        <div class="text-content font-gellix flex flex-col justify-center items-center gap-y-6 xs:pt-[100px] xs:pb-[50px] md:pt-[120px]  xl:pb-[80px] xl:pt-[140px]  xl:my-auto xl:py-0">
            ...
            <p class="case-study-desc text-black font-normal md:text-[16px] text-left w-auto 2xl:max-w-[80%]" :class="{'hidden': isMobile}" >Older adults often face challenges in using technology due to complex interfaces and unfamiliar workflows. 
        ...
        <div class="goal flex flex-col flex-wrap font-gellix sm:pt-[110px] gap-y-10 ">
            ...
            <div class="">
                ...
                <p class="text-[16px] text-gray-700 text-left py-2" >Demographics: Primarily adults aged 60+ who want to preserve their life stories. Psychographics: 
         ...
         <div class="design-process font-gellix flex flex-col sm:pt-[130px]">
            ...
            <p class="text-gray-700 text-[18px] font-normal xs:text-center md:text-left"><span class="text-black font-extrabold text-[20px]">Competitive Analysis: </span>Analyzed existing memory-preservation tools to identify gaps, 
        ...
        <div class=" flex flex-col flex-wrap font-gellix sm:pt-[60px] gap-y-10">
            <div class="">
                ...
                <p class="text-[16px] text-gray-800 text-left py-1" >Assistance: Making the role of the ‘Genie’ clear, showing that this is a supportive feature aimed at guiding users through the memory-preservation process.</p>
                <p class="text-[16px] text-gray-800 text-left py-1" >Emotional Connection: Emphasizing features that let users reflect on their life journey and create a product they feel is deeply personal.</p>
            </div>
            <div class="">
                <p class="font-extrabold text-black text-[24px] uppercase">Wireframing and Prototyping</p>
                <p class="text-gray-700 text-[18px] font-normal text-left py-2"><span class="text-black font-extrabold text-[20px]">Low-Fidelity Wireframes: </span> Began with hand-drawn sketches to map out the basic layout and flow, 
        ...
        <div class=" flex flex-col flex-wrap justify-start items-start font-gellix sm:pt-[60px] gap-y-10">
            <div class="">
                <p class="font-extrabold text-black text-[24px] uppercase">Wireframing and Prototyping</p>
                <p class="text-gray-700 text-[18px] font-normal text-left py-2"><span class="text-black font-extrabold text-[20px]">High-Fidelity Wireframes: </span> Developed a fully interactive prototype in Figma, incorporating color, typography, and accessible UI elements to mirror the final design</p>
            </div>  
        </div>
