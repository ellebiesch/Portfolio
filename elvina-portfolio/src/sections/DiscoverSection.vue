        ...
        <div class="content-wrapper flex flex-col items-center justify-center bg-[#fafafa] md:py-32 container">
            ...
            <div class="company-logo-wrapper flex flex-row flex-wrap gap-10 sm:max-w-[445px] lg:max-w-full justify-center mx-[15px]">
                <div class="item flex flex-col justify-start items-center lg:max-w-[370px]">
                    ...
                    <div class="text-content font-gellix flex flex-col justify-start flex-wrap gap-y-6">
                        ...
                        <div class="case-button flex flex-row gap-x-4 items-center">
                          <router-link to="/case-studies" class="case-button flex flex-row gap-x-4 items-center">
                             <p class="text-black font-medium lg:text-base font-gellix">See Case Study</p>
                             <img src="@/assets/arrow-button.svg" class="min-h-[24px] w-auto" alt="arrow-right">
                           </router-link>
                        </div>
                    </div>
                </div>
