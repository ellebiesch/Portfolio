<template>
    <section class="h-auto">
        <div class=" mt-[100px] flex flex-row items-center justify-evenly flex-wrap font-inter bg-[#fafafa] md:py-20">
            <div class="title">
                <h1 class="font-extrabold text-[40px] text-center">Testimonials</h1>
            </div>
            <div class="wrapper">
                <div class="item flex flex-row items-start md:gap-6 sm:gap-4 md:pt-5">
                    <img v-lazy="testimonialUser" class="rounded-full md:w-[72px] min-h-[70px]" alt="testimonial user">
                    <div class="content flex flex-col justify-start items-start md:w-[542px] min-h-[190px] gap-2">
